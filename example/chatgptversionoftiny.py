...
class tiny_fsm_t:
    ...
    def tiny_fsm_send_signal(self, signal: TINY_FSM_SIGNAL_T, data):
...
def tiny_fsm_state_t(fsm: tiny_fsm_t, signal: TINY_FSM_SIGNAL_T, data):
    pass
...
def led_off_state(fsm: tiny_fsm_t, signal: TINY_FSM_SIGNAL_T, data):
...
def led_on_state(fsm: tiny_fsm_t, signal: TINY_FSM_SIGNAL_T, data):
    if signal == TINY_FSM_SIGNAL_ENTRY:
